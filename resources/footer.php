	...
	//theme settings
		if (is_array($_SESSION['theme']) && @sizeof($_SESSION['theme']) != 0) {
			...
			//pre-process some settings
				...
				$settings_array['theme']['footer'] = '&copy; 2024 &ndash; 2025 <strong>CCL</strong>. All rights reserved. Powered by <a href="https://telcobright.com" target="_blank">Telcobright Limited</a>.';
