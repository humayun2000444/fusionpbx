...
var server = "wss://103.95.96.100:3000";
...
function registerUsername() {
	...
	var sipserver = "sip:103.95.96.100:5060";
...
function doCall(ev) {
	...
	var username = `sip:${$('#peer' + suffix).val()}@103.95.96.100`;
	if(username === "") {
	...
	actuallyDoCall(handle, `sip:${$('#peer' + suffix).val()}@103.95.96.100`, doVideo);
}
