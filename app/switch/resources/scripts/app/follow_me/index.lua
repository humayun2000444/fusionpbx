		...
		--process according to user_exists, sip_uri, external number
			...
			elseif (tonumber(destination_number) == nil) then
				...
				--so C party sees B's number, not A's number
					freeswitch.consoleLog("NOTICE", "[follow_me CID fix] call_direction=" .. tostring(call_direction) .. " caller_destination=" .. tostring(caller_destination) .. " caller_id_number=" .. tostring(caller_id_number) .. "\n");
					if (call_direction == "inbound" and caller_destination ~= nil and caller_destination ~= "") then
						...
						freeswitch.consoleLog("NOTICE", "[follow_me CID fix] APPLIED: caller_id_number now=" .. tostring(caller_id_number) .. "\n");
					end
